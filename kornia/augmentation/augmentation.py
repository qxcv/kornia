...
class RandomAffine(AugmentationBase):
    r"""Random affine transformation of the image keeping center invariant.
        ...
        Args:
            ...
            padding_mode (str, optional): border-handling mode for ``warp_affine``.
    ...
    def __init__(
        ...
        return_transform: bool = False, same_on_batch: bool = False, padding_mode: Optional[str] = None,
    ) -> None:
    ...
    def __repr__(self) -> str:
        repr = f"(degrees={self.degrees}, translate={self.translate}, scale={self.scale}, shear={self.shear}, " \
            f"resample={self.resample.name}, return_transform={self.return_transform}, " \
            f"same_on_batch={self.same_on_batch}, padding_mode={self.padding_mode}"
        return self.__class__.__name__ + repr
    ...
    def get_params(self, batch_shape: torch.Size) -> Dict[str, torch.Tensor]:
        return rg.random_affine_generator(
            ...
            self.resample, self.padding_mode, self.same_on_batch)
